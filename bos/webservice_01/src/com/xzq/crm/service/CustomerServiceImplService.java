 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://service.crm.xzq.com/", wsdlLocation = "http://192.168.2.60:8080/crm/service/customer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://service.crm.xzq.com/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.2.60:8080/crm/service/customer?wsdl");
    ...
    public ICustomerService getCustomerServiceImplPort() {
        return super.getPort(new QName("http://service.crm.xzq.com/", "CustomerServiceImplPort"), ICustomerService.class);
    }
    ...
    public ICustomerService getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.crm.xzq.com/", "CustomerServiceImplPort"), ICustomerService.class, features);
    }
