...
<script type="text/javascript">
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: xuzq@liwinon.com");
	}
</script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
			...
			<div onclick="showAbout();" data-options="iconCls:'icon-tip'">联系管理员</div>
			<div class="menu-sep"></div>
			<div onclick="logoutFun();" data-options="iconCls:'icon-cancel'">退出系统</div>
		</div>
	</div>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							许智强 | Powered by <a href="http://www.baidu.cn/">xzq.cn</a>
						</div>
					</td>
            ...
            <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
               <form id="editpasswordForm">
                <table cellpadding=3>
                    <tr>
                        <td>原密码：</td>
                        <td><input id="txtOldPass" required="true" data-options="validType:'length[4,6]'"  type="Password" class="txt01 easyui-validatebox" /></td>
                    </tr>
                    <tr>
                        <td>新密码：</td>
