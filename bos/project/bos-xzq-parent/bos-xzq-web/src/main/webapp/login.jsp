...
<body>
	<div
		style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -550px;; margin-top: -300px;">
		<span style="float: left; margin-top: 35px; color: #488ED5; font-size:22px;">新BOS系统，致力于便捷、安全、稳定等方面的客户体验</span>
	</div>
	<div class="main-inner" id="mainCnt"
		style="width: 1100px; height: 540px; overflow: hidden; position: absolute; left: 50%; top: 50%; margin-left: -550px; margin-top: -220px; background-image: url('${pageContext.request.contextPath }/images/bg_login.jpg')">
		<div id="loginBlock" class="login"
			style="margin-top: 100px; height: 255px;left:-400px;">
			<div class="loginFunc">
	...
	<div
		style="width: 900px; height: 50px; position: absolute; text-align: left; left: 50%; top: 50%; margin-left: -550px;; margin-top: 320px;">
		<span style="color: #488ED5;">Powered By www.baidu.cn</span><span
			style="color: #488ED5;margin-left:10px;">推荐浏览器（右键链接-目标另存为）：<a
			href="https://github.com/812063047/Object">Firefox</a>
		</span>
	</div>
</body>
</html>