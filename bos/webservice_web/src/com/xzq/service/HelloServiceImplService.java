 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://service.xzq.com/", wsdlLocation = "http://localhost:8080/CXF_Service/service/cxfService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://service.xzq.com/", "HelloServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CXF_Service/service/cxfService?wsdl");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://service.xzq.com/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.xzq.com/", "HelloServiceImplPort"), HelloService.class, features);
    }
